...
class CourseByCourseSlugResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'category' => $this->course_category()->pluck('slug')->first(),
            'category_name' => $this->course_category()->pluck('name')->first(),
